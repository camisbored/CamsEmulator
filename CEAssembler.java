...
public class CEAssembler {
	...
	static {
		...
		opCodeMap.put("strr1",new byte[]{0x06, 0x01});
		opCodeMap.put("strr2",new byte[]{0x07, 0x01});
		opCodeMap.put("strr3",new byte[]{0x08, 0x01});
		opCodeMap.put("strr4",new byte[]{0x09, 0x01});
		opCodeMap.put("strr5",new byte[]{0x0A, 0x01});
		opCodeMap.put("ldrr1",new byte[]{0x0B, 0x01});
		opCodeMap.put("ldrr2",new byte[]{0x0C, 0x01});
		opCodeMap.put("ldrr3",new byte[]{0x0D, 0x01});
		opCodeMap.put("ldrr4",new byte[]{0x0E, 0x01});
		opCodeMap.put("ldrr5",new byte[]{0x0F, 0x01});
